var t={};Object.defineProperty(t,"__esModule",{value:!0}),t.flyg=void 0;var e=function(t){return t instanceof Element},n=function(t){return String(t).replace(/[^\w. ]/gi,(function(t){return"&#"+t.charCodeAt(0)+";"}))},s=function(t){var e=document.createElement("template");return t=t.trim(),e.innerHTML=t,e.content.firstChild};t.flyg=function(t){for(var i=[],r=1;r<arguments.length;r++)i[r-1]=arguments[r];for(var l="",a={},o=0;o<t.length;o++){var d=i[o],c=t[o];if(l+=c,"string"!=typeof d&&"number"!=typeof d&&"boolean"!=typeof d||(l+=n(d)),"object"==typeof d){if(!e(d))throw new Error("Value must be a string, number, boolean or a DOM element");var k="flyg-".concat(o);a[k]=d,l+='<template id="'.concat(k,'"></template>')}}var v=s(l);return Object.entries(a).forEach((function(t){var e=t[0],n=t[1];v.querySelector("template#".concat(e)).replaceWith(n)})),v};const i=e=>{const n=t.flyg`
    <div class="menu">
      ${t.flyg`
...
//# sourceMappingURL=index.a3686ce8.js.map
