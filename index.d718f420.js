var e={};Object.defineProperty(e,"__esModule",{value:!0}),e.flyg=void 0;var t=function(e){return e instanceof Element},s=function(e){return String(e).replace(/[^\w. ]/gi,(function(e){return"&#"+e.charCodeAt(0)+";"}))},n=function(e){var t=document.createElement("template");return e=e.trim(),t.innerHTML=e,t.content.firstChild};e.flyg=function(e){for(var i=[],r=1;r<arguments.length;r++)i[r-1]=arguments[r];for(var a="",o={},l=0;l<e.length;l++){var d=i[l],c=e[l];if(a+=c,"string"!=typeof d&&"number"!=typeof d&&"boolean"!=typeof d||(a+=s(d)),"object"==typeof d){if(!t(d))throw new Error("Value must be a string, number, boolean or a DOM element");var m="flyg-".concat(l);o[m]=d,a+='<template id="'.concat(m,'"></template>')}}var f=n(a);return Object.entries(o).forEach((function(e){var t=e[0],s=e[1];f.querySelector("template#".concat(t)).replaceWith(s)})),f};const i=()=>{const t=e.flyg`
    <div class="menu">
      ${e.flyg`
...
<style type="text/css">
  ...
  `;t.querySelectorAll(".menu-item").forEach((e=>{e.addEventListener("click",(e=>{t.classList.remove("menu--opened"),t.classList.add("menu--closed"),t.dispatchEvent(new CustomEvent("navigation",{detail:Number(e.target.closest(".menu-item").getAttribute("data-value"))}))}))}));const s={open:()=>{t.classList.add("menu--opened"),t.classList.remove("menu--closed")},setVideoSource:s=>{t.replaceChild(e.flyg`
          <video autoplay muted loop>
            <source src="${s}" type="video/mp4">
            Your browser does not support the video tag.
          </video>
      `,t.querySelector("video"))}};return{component:t,actions:s}},r=()=>e.flyg`
