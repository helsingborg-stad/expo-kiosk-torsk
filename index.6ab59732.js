var t={};Object.defineProperty(t,"__esModule",{value:!0}),t.flyg=void 0;var e=function(t){return t instanceof Element},s=function(t){return String(t).replace(/[^\w. ]/gi,(function(t){return"&#"+t.charCodeAt(0)+";"}))},n=function(t){var e=document.createElement("template");return t=t.trim(),e.innerHTML=t,e.content.firstChild};t.flyg=function(t){for(var l=[],a=1;a<arguments.length;a++)l[a-1]=arguments[a];for(var r="",i={},o=0;o<t.length;o++){var d=l[o],c=t[o];if(r+=c,"string"!=typeof d&&"number"!=typeof d&&"boolean"!=typeof d||(r+=s(d)),"object"==typeof d){if(!e(d))throw new Error("Value must be a string, number, boolean or a DOM element");var k="flyg-".concat(o);i[k]=d,r+='<template id="'.concat(k,'"></template>')}}var m=n(r);return Object.entries(i).forEach((function(t){var e=t[0],s=t[1];m.querySelector("template#".concat(e)).replaceWith(s)})),m};const l=e=>{const s=t.flyg`
    <div class="menu">
      ${t.flyg`
...
//# sourceMappingURL=index.6ab59732.js.map
